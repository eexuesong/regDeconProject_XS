...
%% Load data
% load raw data
filename_data = 'Stack_1.tif';
path_data = 'D:\Code\Matlab_Code\Code_from_Min\regDeconProject-master_XS\WBDeconvolution\DataForTest_lightsheet';
% load PSF data
...
for imgNum = t1:t2
    ...
    for i = 1:itNum
        %         Estimate = Estimate .* ConvFFT3_S(stack ./ ConvFFT3_S(Estimate, OTF_fp), OTF_bp);
